    ...
    return (
        <Card className="group relative flex flex-col justify-between overflow-hidden border-border bg-card transition-all hover:shadow-md dark:border-zinc-800">
            <CardContent className="p-6">
                ...
                {/* Hover Action */}
                <div className="absolute inset-x-0 bottom-0 flex translate-y-full flex-col justify-end bg-gradient-to-t from-card via-card to-transparent p-6 opacity-0 transition-all duration-300 group-hover:translate-y-0 group-hover:opacity-100">
